...
public class CustomerKafkaConsumer {
    ...
    public ConsumerFactory<String, NotificationRequest> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "customerKafkaGroup");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(NotificationRequest.class));
    }
