...
@Schema(name = "Error", description = "The Error object contains information about the error")
...
public class Error   {
  ...
  */
  @NotNull 
  @Schema(name = "code", example = "666", required = true)
  ...
  */
  @NotNull 
  @Schema(name = "message", example = "Any error message", required = true)
